    ...
    public class UploadHandle : IUEditorHandle
    {
        ...
        public object Process()
        {
            ...
            try
            {
                ...
                var imageHost = System.Configuration.ConfigurationManager.AppSettings["ImageHost"] == "" ? string.Format("http://{0}{1}", HttpContext.Current.Request.Url.Host, HttpContext.Current.Request.Url.Port == 80 ? "" : ":" + HttpContext.Current.Request.Url.Port) : System.Configuration.ConfigurationManager.AppSettings["ImageHost"];
                Result.Url = imageHost + savePath;
