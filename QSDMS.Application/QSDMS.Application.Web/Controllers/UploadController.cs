...
namespace QSDMS.Application.Web.Controllers
{
    public class UploadController : Controller
    {
        ...
        {
            ReturnMessage rs = new ReturnMessage(false);
            try
            {
                ...
                {
                    rs.IsSuccess = true;
                    rs.ResultData["path"] = result.ResultData["files"].ToString();
                }
            }
            catch (Exception ex)
            {
        ...
        public JsonResult UploadFile()
        {
            ...
            try
            {
                ...
                string virtualPath = string.Format("/File/AttachmentPic/{0}{1}", DateTime.Now.ToString("yyyyMMddHHmmss"), FileEextension);
