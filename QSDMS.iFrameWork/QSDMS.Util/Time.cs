...
namespace QSDMS.Util
{
    ...
    public class Time
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static DateTime GetCurrentMonthFirstDay(DateTime someDate)
        {
            return someDate.AddDays(1 - someDate.Day).Date;
        }
        /// <summary>
        /// 返回当前月的最后一天
        /// </summary>
        /// <returns></returns>
        public static DateTime GetCurrentMonthLastDay(DateTime someDate)
        {
            return someDate.AddDays(1 - someDate.Day).Date.AddMonths(1).AddSeconds(-1);
        }

        //public List<DateTime> GetCurrentMonthList()
        //{
        //    List<DateTime> list = new List<DateTime>();
        //    var firstday = GetCurrentMonthFirstDay();
        //    var lastday = GetCurrentMonthFirstDay();
        //    while (true)
        //    {
